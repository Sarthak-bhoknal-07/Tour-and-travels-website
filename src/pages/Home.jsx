...
import { ShieldCheck, Clock, Map, Star, ChevronDown, Phone, MessageSquare } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="bg-brand-dark min-h-screen text-white overflow-x-hidden font-sub">
      ...
      {/* SECTION 3 — OUR FLEET */}
      <section className="py-24 bg-brand-deepblue grid-pattern relative px-0 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory pb-8 px-6 gap-6 md:grid md:grid-cols-2 lg:grid-cols-3 md:overflow-visible md:snap-none md:pb-0 md:px-0">
      ...
      {/* SECTION ABOUT US (Inserted below Fleet) */}
      <About />
      ...
      {/* SECTION 6 — PAYMENT */}
      <section className="py-24 bg-brand-deepblue px-6">
        <div className="max-w-3xl mx-auto glass-card p-8 md:p-12 text-center border border-white/5 shadow-2xl">
          <h2 className="text-3xl sm:text-4xl font-heading font-black text-white mb-6">
            Payment <span className="gold-text">Guide</span>
          </h2>
          <p className="text-gray-300 mb-10 font-medium">
            Scan the QR code below for easy and secure payment. Please share a screenshot of the payment on WhatsApp after completion.<br/>
            <span className="text-brand-gold font-bold">पेमेंट झाल्यावर त्याचा स्क्रीनशॉट आम्हाला व्हॉट्सॲपवर पाठवा.</span>
          </p>
          <div className="flex justify-center">
            <img src="/assets/qr.jpeg" alt="Payment QR Code" className="w-64 h-64 md:w-80 md:h-80 rounded-2xl shadow-lg border-4 border-brand-gold" />
          </div>
        </div>
      </section>
    </div>
